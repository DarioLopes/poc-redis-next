				...
				<div className="flex flex-col space-y-2">
					<label>
						<input
							...
							className="mr-2"
							disabled={isPending}
							defaultChecked={defaultValue?.data.preferences?.includes('newsletters')}
						/>
						Newsletters
					</label>
					<label>
						<input
							...
							className="mr-2"
							disabled={isPending}
							defaultChecked={defaultValue?.data.preferences?.includes('updates')}
						/>
						Product Updates
					</label>
					<label>
						<input
							...
							className="mr-2"
							disabled={isPending}
							defaultChecked={defaultValue?.data.preferences?.includes('offers')}
						/>
						Special Offers
					</label>
				</div>
